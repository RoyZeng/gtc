...
defined('STATICS_DATA_PATH') or define('STATICS_DATA_PATH', RUNTIME_PATH.'Statics/'); // 静态文件缓存目录
defined('UPLOAD_PATH') or define('UPLOAD_PATH', 'upload/'); // 静态文件缓存目录
...
function load_runtime_file() {
    ...
    if(!is_dir(STATICS_DATA_PATH))  mkdir(STATICS_DATA_PATH,0755,true);   // 静态文件缓存目录
    if(!is_dir(UPLOAD_PATH))  mkdir(UPLOAD_PATH,0755,true);   // 上传目录
}
